...
class Day1:
    file_path = CURR_DIR / 'day1_input.txt'

    @staticmethod
    def Part1() -> int:
        start_val = 50
        total_zero_hit = 0
        with open(Day1.file_path, 'r') as input:
            for line in input:
                mover = int(line[1:])
...
class Day2:
    file_path = CURR_DIR / 'day2_input.txt'

    @staticmethod
    def Part1() -> int:
        total_sum = 0
        with open(Day2.file_path, 'r') as input:
...
class Day3:
    file_path = CURR_DIR / 'day3_input.txt'

    @staticmethod
    def Part1() -> int:
        total_joltage = 0
        with open(Day3.file_path, 'r') as input:
            for line in input:
...
class Day4:
    file_path = CURR_DIR / 'day4_input.txt'
    ...
    def Part1() -> int:
        input_list = []
        with open(Day4.file_path, 'r') as input:
            for line in input:
